...
import com.fairphone.fplauncher3.WallpaperCropActivity;
import com.fairphone.fplauncher3.R;
import com.fairphone.fplauncher3.FolderIcon.FolderRingAnimator;
import com.fairphone.fplauncher3.Launcher.CustomContentCallbacks;
...
public class Workspace extends SmoothPagedView
    ...
    class WallpaperOffsetInterpolator implements Choreographer.FrameCallback {
        ...
        private void updateOffset(boolean force) {
            if (mWaitingForUpdate || force) {
                ...
                if (mNumPagesForWallpaperParallax > 0 && computeScrollOffset() && mWindowToken != null) {
                    try {
    ...
    */
    ...
    Animator getChangeStateAnimation(final State state, boolean animated, int delay, int snapPage,
        ...
        if (animated) {
            ...
            if (pageIndicator != null) {
                ...
                pageIndicatorAlpha.addListener(new AlphaUpdateListener(pageIndicator, finalHotseatAndPageIndicatorAlpha));
            } else {
    ...
    public void onDrop(final DragObject d) {
        ...
        if (d.dragSource != this) {
            final int[] touchXY = { (int) mDragViewVisualCenter[0],
